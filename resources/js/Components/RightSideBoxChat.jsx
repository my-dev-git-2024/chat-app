                ...
                <div className="relative flex flex-row-reverse group">
                    <div className={clsx(message.message_deleted_at ? '' : 'lg:pr-20', "px-3 py-2 text-xs text-gray-300 bg-gray-800 rounded-md lg:text-sm")}>
                        ...
                        {/* {!message.message_deleted_at ?
                            <>
                            {message.message && (
                                <div className="break-all whitespace-pre-wrap mb-2">{message.message}</div>
                            )}
                            ...
                            {message.image_path && (
                                ...
                                <img
                                    ...
                                    alt="chat media"
                                    className="rounded-md max-w-xs lg:max-w-sm mb-2"
                                />
                                </div>
                       ...
                       {!message.message_deleted_at ? (
                            <>
                                {message.message && message.message.startsWith('storage/chat_images/') ? (
                                    <img
                                        src={`/${message.message}`}
                                        alt="chat media"
                                        className="rounded-md max-w-xs lg:max-w-sm mb-2"
                            ...
                            <div className="text-xs italic text-gray-400/60 text-center">
                                {message.message}
                            </div>
                        )}
                        {/* Chat Timestamp */}
