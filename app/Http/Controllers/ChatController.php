   ...
   public function chat(User $user, ChatRequest $request)
{
    ...
    // Store image if uploaded
     ...
     if ($request->hasFile('image')) {
        // Store image and save path in message field
        $imagePath = $request->file('image')->store('chat_images', 'public');
        $messageText = 'storage/' . $imagePath;
    }
    ...
    //     // If no message, use image info as message fallback
    //     if (!$messageText) {
    //         $messageText = '[Image] ' . 'storage/' . $imagePath;
    //     }
    // }
